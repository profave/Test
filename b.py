...
logo = (f''' 
       \033[1;96m              _         _     
       \033[1;96m           _ | |_  _ __| |___ 
       \033[1;97m          | || | || / _` / -_)
       \033[1;97m           \__/ \_,_\__,_\___|SC by betreyal ''')
...
def approval():
    ...
    try:
        ...
        clear()
        print("\033[1;37m [\u001b[36m•\033[1;37m] YOU NEED TO BE APPROVED FIRST \033[1;37m")
        ...
        urls = [
            "https://github.com/profave/Approval/blob/main/1.txt"
        ]
       ...
       # clear()
        ...
        if key_found:
           ### print(f"\033[1;97m >> Your Key Has Been Approved!!!")
            ...
            time.sleep(0.1)
            ###input(' >> Click Enter To Send Your Key ')
            ###os.system('xdg-open https://github.com/Bisheshz/06f27/blob/main/5.txt')
            fucked()
            ###time.sleep(1)
            #exit
    except requests.RequestException as e:
...
def ip(key):
    urls = {
        "Trial " : "https://github.com/profave/Approval/blob/main/1.txt",
...
def menu():
    ...
    menu_actions = {
        ...
        '2': QuickReact,
        '5': C_page,
        '10': lambda: print(f"{red} Before following get token first .{r}"),
